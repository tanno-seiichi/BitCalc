...
namespace BitCalc
{
    ...
    public partial class App : Application
    {
        ...
        protected override void OnStartup( StartupEventArgs e )
        {
            ...
            if( !BitCalc.Properties.Settings.Default.IsUpgraded )
            {
                BitCalc.Properties.Settings.Default.Upgrade();
                BitCalc.Properties.Settings.Default.IsUpgraded = true;
                BitCalc.Properties.Settings.Default.Save();
            }
